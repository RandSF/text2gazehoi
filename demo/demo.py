...
def main(config):
    ...
    eval_name = data_config.eval_name if hasattr(data_config, 'eval_name') else dataset_name
    ...
    renderer = Renderer(device="cuda", camera=f"{eval_name}_front")
        ...
        for batch_idx in range(batch_num):
            ...
            input_lhand, input_rhand, refined_x_obj, \
                = proc_refiner_input(
                    ...
                    valid_mask_lhand, valid_mask_rhand, valid_mask_obj, 
                    est_contact_map, eval_name, obj_pc_top_idx=obj_pc_top_idx_batch
                )
