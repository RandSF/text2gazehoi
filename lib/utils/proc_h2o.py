...
def process_text(
    ...
    text_descriptions, return_key=False, extra_gaze=False,
):
    ...
    if return_key:
        ...
        if extra_gaze:
            obj_name = action_name.split(' ')[1]
            # text = text + f"The gaze focuses on the {obj_name}."
            text = (text[:-1] + ' and gaze.' ).capitalize()
        return text
