...
from lib.datasets.hot3d import (
    SequenceHOT3D, ContactHOT3D, MotionHOT3D
)
...
def get_dataset(dataset_name, dataset_config, test=False):
    ...
    elif dataset_name == "Sequencehot3d":
        dataset = SequenceHOT3D(**dataset_config)
    elif dataset_name == "Contacthot3d":
        dataset = ContactHOT3D(**dataset_config)
    elif dataset_name == "Motionhot3d":
        dataset = MotionHOT3D(**dataset_config)
    return dataset
